...
datastory_name <- "fields_of_research_and_disciplines"
...
# characters etc.)
# -> Don't put "datastory" at the start or end!
datastory_name_en <- "fields-of-research-and-scientific-disciplines"
datastory_name_de <- "forschungsfelder-und-wissenschaftliche-Disziplinen"
datastory_name_fr <- "domaines-de-recherches-et-classification-scientifique"

# English title and lead of the story (Mandatory, even if no EN version)
title_en <- "New classification of scientific disciplines in the SNSF Portal"
lead_en <- "With the launch of the SNSF Portal for the submission of funding applications, the SNSF has also introduced a new classification of disciplines. This corresponds to an international standard and offers several advantages."
# German title and lead of the story (Mandatory, even if no DE version)
title_de <- "Neue Klassifikation der wissenschaftlichen Disziplinen im SNF-Portal"
lead_de <- "Mit dem SNF-Portal für die Einreichung von Fördergesuchen hat der SNF auch eine neue Klassifikation der Disziplinen eingeführt. Diese entspricht einem internationalen Standard und bietet mehrere Vorteile."
# French title and lead of the story (Mandatory, even if no FR version)
title_fr <- "Nouvelle classification des disciplines scientifiques dans le Portail FNS"
lead_fr <- "Le FNS a profité de la mise en ligne du Portail FNS dédié à la soumission des requêtes pour introduire une nouvelle classification des disciplines. Conforme à un standard international, celle-ci recèle une multitude d’avantages."
# Contact persons, always (first name + last name)
authors <-
  list(
    en = c("Jonathan Wust, Data Team, SNSF",
           "Anne Jorstad, Data Team, SNSF"),
    de = c("Jonathan Wust, Data Team, SNF",
           "Anne Jorstad, Data Team, SNF"),
    fr = c("Jonathan Wust, Data Team, FNS",
...
publication_date <- "2024-07-23 04:00:00"
...
tags_ids <- 330 # Thematic research and disciplines
