...
::: plot-box
<div class="plot-title">Comment les champs de recherche sont-ils attribués aux trois domaines utilisés par le FNS (SHS, MINT, LS) ?</div>
```{r}
#| fig-height: 12.5
